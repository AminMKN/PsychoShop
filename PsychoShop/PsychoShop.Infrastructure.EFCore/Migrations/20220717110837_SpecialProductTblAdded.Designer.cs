...
namespace PsychoShop.Infrastructure.EFCore.Migrations
{
    ...
    [Migration("20220717110837_SpecialProductTblAdded")]
    partial class SpecialProductTblAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PsychoShop.Domain.ProductPictureAgg.ProductPicture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PsychoShop.Domain.ProductSubCategoryAgg.ProductSubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PsychoShop.Domain.SpecialProductAgg.SpecialProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PsychoShop.Domain.UserAccountAgg.UserAccount", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PsychoShop.Domain.ProductAgg.Product", b =>
                {
                    ...
                    b.HasOne("PsychoShop.Domain.ProductSubCategoryAgg.ProductSubCategory", "ProductSubCategory")
                        .WithMany("Products")
